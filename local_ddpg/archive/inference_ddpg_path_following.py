...
Loads a trained DDPG checkpoint (produced by ddpg_path_following.py) and
runs the policy against a reference B-spline path built from a manual
control-point JSON file. Saves a single PNG comparing:
...
Usage:
    python inference_ddpg_path_following.py \
        ...
        --checkpoint solves_drl/ddpg_path_following_map_001_robot_2.pt \
        --start_frac 0.0 \
        --max_steps 400
"""
...
from local_ddpg.archive.ddpg_path_following import (
    ReferencePath,
    PathFollowEnv,
    DDPGAgent,
